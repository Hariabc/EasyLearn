...
const ComputerLanguages = () => {
  ...
  if (loading) return <div className="p-8 text-center text-blue-400 font-semibold animate-pulse">Loading computer languages...</div>;
  if (error) return <div className="p-8 text-center text-red-400 font-semibold">Error: {error}</div>;
